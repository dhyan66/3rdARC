  ...
  return (
    <div className="py-8 sm:py-12">
      <div className="mx-auto max-w-[1200px]">
        {/* Two-Column Grid: 50% content, 50% portrait */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
          {/* Left Column - Biography & Content (50% = 1/2) */}
            ...
            <section className="border-t border-gray-200 pt-6 sm:pt-8 mt-auto">
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                {photographer.contact.instagram && (
                  <div className="flex items-center gap-3">
                    <Instagram className="w-4 h-4 sm:w-5 sm:h-5 text-gray-500 flex-shrink-0" />
                    <a
          ...
          {/* Right Column - Professional Portrait (50% = 1/2) */}
